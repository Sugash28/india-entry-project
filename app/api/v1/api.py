...
from app.api.v1.endpoints import auth, service_provider, client, project, contract
...
api_router.include_router(contract.router, prefix="/client/contracts", tags=["contracts"])
